...
import cv2
import numpy as np
from src.conf.Configurations import pytesseract_path

# Set the path to tesseract.exe (Only needed for Windows users)
pytesseract.pytesseract.tesseract_cmd = pytesseract_path

class TextAndImageDataExtractor:
    ...
    def extract_text_from_pdf(pdf_path):
        ...
        for page_number in range(len(doc)):
            ...
            for img_index, img in enumerate(images):
                ...
                processed_image = TextAndImageDataExtractor().preprocess_image(image)
...
# Path to the PDF file and extract text and images
__name__ = "__main__"
sample_pdf_path = r"C:\Docs1\text_and_images.pdf"
text_data = TextAndImageDataExtractor().extract_text_from_pdf(sample_pdf_path)
